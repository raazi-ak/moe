...
class SystemValuesWidget extends StatefulWidget {
  final String id;
  const SystemValuesWidget({super.key, required this.id});
      ...
      child: BlocBuilder<DashboardDataBloc, DashboardDataState>(
        builder: (context, state) {
          if (state is SystemDataLoading) {
            ...
            safePrint(state.data);
            final formattedData = _processData(state.data);
            safePrint("POST FORMATTING======================================================");
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Text(
                                "${formattedData["Inverter"]["total_bus_power"]}",
                                style: TextStyle(
                                  color: theme.white,
                                  fontSize: 20.0,
